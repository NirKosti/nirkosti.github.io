...
The [SUPA project](https://www.supa.uio.no/english/) addresses the pressing issue of administrative overburdening in advanced democracies. It has two main objectives. First, to improve decision-making processes in order to limit the administrative burdens caused by excessive rulemaking. Second, to optimize administrative structures for more effective management of ongoing rule growth.

SUPA is structured around seven interlinked Work Packages, each addressing a key dimension of rule growth and its implications for modern governance. Together, they generate new empirical data, develop theoretical insights, and offer practical tools to understand and manage the increasing complexity of legal and administrative systems across Europe. Learn more about the [SUPA team](https://www.supa.uio.no/english/people/index.html) and the [work packages](https://www.supa.uio.no/english/research/index.html).
